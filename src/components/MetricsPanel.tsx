  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <CardContent className="p-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-bold">{formatPrice(metrics.currentPrice)}</span>
              <div className={`flex items-center text-sm ${metrics.dailyChangePercent >= 0 ? 'text-green-500' : 'text-red-500'}`}>
                {metrics.dailyChangePercent >= 0 ? <TrendingUp size={16} /> : <TrendingDown size={16} />}
      ...
      <Card className="bg-accent">
        <CardContent className="p-4">
          <div className="flex flex-col">
            ...
            <div className={`flex items-center text-2xl font-bold ${metrics.dailyChange >= 0 ? 'text-green-500' : 'text-red-500'}`}>
      ...
      <Card className="bg-accent">
        <CardContent className="p-4">
          <div className="flex flex-col">
            <span className="text-sm font-medium text-muted-foreground">Volume (Avg)</span>
